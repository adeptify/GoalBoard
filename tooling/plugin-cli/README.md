...
Workspace path: `tooling/plugin-cli`  
Contract entrypoint: `@adeptify/goalboard-contracts/platform/tooling`

## Purpose

Plugin creation, Manifest/Contract validation, local debugging, packaging, and signing workflow boundary.

This package explicitly does **not** own A fake runnable CLI before the SDK and lifecycle implementation exist.
