# @adeptify/goalboard-module-automation

<!-- Generated as the F2 contract-only workspace boundary. -->

Status: `contract-only`  
Workspace path: `modules/automation`  
Contract entrypoint: `@adeptify/goalboard-contracts/modules/automation`

## Purpose

Trigger, Rule, Automation Run, deduplication, and generated Action references.

This package explicitly does **not** own Action dispatch, Provider calls, Scheduler leases, or a general Event Bus.
...
```bash
pnpm --filter @adeptify/goalboard-module-automation typecheck
pnpm --filter @adeptify/goalboard-module-automation build
```
